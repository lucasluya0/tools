...
public class HttpClientUtil {
	public static void main(String[] args) {
        ...
        createMap.put("enterpriseId","****2222*");  
        createMap.put("enterpriseName","**3333**");
        
        String REP = HttpClientUtil.doPost(httpOrgCreateTest,createMap,"utf-8");  
        System.out.println("result:"+REP); 
        
		
		String REG = HttpClientUtil.sendGet(httpOrgCreateTest,per);
